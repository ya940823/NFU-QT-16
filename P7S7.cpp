...
P7S7::P7S7(QGraphicsScene *scene, QObject *parent)
    ...
    connect(frTimer, &QTimer::timeout, this, &P7S7::toggleFR);
    connect(ol, &CircuitComponent::pressed, this, &P7S7::handleolPressed);
    // Connect button signals
    connect(pb1, &CircuitComponent::pressed, this, &P7S7::handlePB1Pressed);
    connect(pb2, &CircuitComponent::pressed, this, &P7S7::handlePB2Pressed);
    connect(pb3, &CircuitComponent::pressed, this, &P7S7::handlePB3Pressed);
    connect(pb4Button, &PB4Button::pressed, this, &P7S7::handlePB4Pressed);
    connect(pb4Button, &PB4Button::released, this, &P7S7::handlePB4Released);
    connect(ls1Button, &PB4Button::pressed, this, &P7S7::handlels1Pressed);
    connect(ls1Button, &PB4Button::released, this, &P7S7::handlels1Released);
    connect(ls2Button, &PB4Button::pressed, this, &P7S7::handlels2Pressed);
    connect(ls2Button, &PB4Button::released, this, &P7S7::handlels2Released);
    resetCircuit();
}
...
void P7S7::handlePB3Pressed() {
    qDebug() << "PB3 Pressed";
    stopMotor();
}
void P7S7::handlePB4Pressed() {
    pb4->setActive(true);
    if(!ol->isActive()){
        qDebug() << "PB4 Pressed";
        pl3->setOn(true);
...
void P7S7::handlePB4Released() {
    pb4->setActive(false);
    qDebug() << "PB4 Released";
    pl3->setOn(false);
}
void P7S7::handlels1Pressed() {
...
void P7S7::handlels1Released() {
    ls1->setActive(false);
    qDebug() << "LS1 Released";
}
void P7S7::handlels2Pressed() {
