...
P5S3::P5S3(QGraphicsScene *scene, QObject *parent)
    ...
    connect(pb1Button, &PB1Button::released, this, &P5S3::handlePB1Released);

    //connect(nfb, &CircuitComponent::pressed, this, &P5CircuitWindow::handlePB1Released);

    // Connect PB2 button signal for motor start
    connect(pb2, &CircuitComponent::pressed, this, &P5S3::handlePB2Pressed);
    connect(cos1, &CircuitComponent::pressed, this, &P5S3::handlecos1Pressed);

    // Connect TH_RY abnormal state
    connect(thRy, &CircuitComponent::pressed, this, &P5S3::handleTHRYTriggered);

    resetCircuit(); // Initialize circuit
}

void P5S3::handlecos1Pressed() { //cos1 true:1, cos1 false:2
