...
P7S3::P7S3(QGraphicsScene *scene, QObject *parent)
    ...
    QString soundFilePath = QDir::currentPath() + "/resources/sound.mp3";
    ...
    connect(frTimer, &QTimer::timeout, this, &P7S3::toggleFR);
    connect(ol, &CircuitComponent::pressed, this, &P7S3::handleolPressed);
    // Connect button signals
    connect(pb1, &CircuitComponent::pressed, this, &P7S3::handlePB1Pressed);
    connect(pb2, &CircuitComponent::pressed, this, &P7S3::handlePB2Pressed);
    connect(pb3, &CircuitComponent::pressed, this, &P7S3::handlePB3Pressed);
    connect(pb4Button, &PB4Button::pressed, this, &P7S3::handlePB4Pressed);
    connect(pb4Button, &PB4Button::released, this, &P7S3::handlePB4Released);
    connect(ls1Button, &PB4Button::pressed, this, &P7S3::handlels1Pressed);
    connect(ls1Button, &PB4Button::released, this, &P7S3::handlels1Released);
    connect(ls2Button, &PB4Button::pressed, this, &P7S3::handlels2Pressed);
    connect(ls2Button, &PB4Button::released, this, &P7S3::handlels2Released);
    resetCircuit();
    QTimer::singleShot(1, this, SLOT(handlePB2Pressed()));
}
void P7S3::handleolPressed() {
    stopMotor();
    if (ol->isActive()) {
        ol->setActive(false);
        fr->setActive(true);
...
void P7S3::handlePB3Pressed() {
    qDebug() << "PB3 Pressed";
    //stopMotor();
}
void P7S3::handlePB4Pressed() {
    pb4->setActive(true);
    if(!ol->isActive()){
        qDebug() << "PB4 Pressed";
        pl3->setOn(true);
...
void P7S3::handlePB4Released() {
    pb4->setActive(false);
    qDebug() << "PB4 Released";
    pl3->setOn(false);
}
void P7S3::handlels1Pressed() {
...
void P7S3::handlels1Released() {
    ls1->setActive(false);
    qDebug() << "LS1 Released";
}
void P7S3::handlels2Pressed() {
