...
P5S2::P5S2(QGraphicsScene *scene, QObject *parent)
    ...
    connect(pb1Button, &PB1Button::pressed, this, &P5S2::handlePB1Pressed);
    connect(pb1Button, &PB1Button::released, this, &P5S2::handlePB1Released);

    //connect(nfb, &CircuitComponent::pressed, this, &P5CircuitWindow::handlePB1Released);

    // Connect PB2 button signal for motor start
    connect(pb2, &CircuitComponent::pressed, this, &P5S2::handlePB2Pressed);
    connect(cos1, &CircuitComponent::pressed, this, &P5S2::handlecos1Pressed);

    // Connect TH_RY abnormal state
    connect(thRy, &CircuitComponent::pressed, this, &P5S2::handleTHRYTriggered);

    resetCircuit(); // Initialize circuit
}

void P5S2::handlecos1Pressed() {
