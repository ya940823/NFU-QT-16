...
P6S2::P6S2(QGraphicsScene *scene, QObject *parent)
    ...
    connect(pb1, &CircuitComponent::pressed, this, &P6S2::handlePB1Clicked);
    connect(pb2, &CircuitComponent::pressed, this, &P6S2::handlePB2Clicked);
    connect(cos1, &CircuitComponent::pressed, this, &P6S2::handlecos1Pressed);

    // Connect OL button signal for motor start
    connect(ol1, &CircuitComponent::pressed, this, &P6S2::handleol1Pressed);
    connect(ol2, &CircuitComponent::pressed, this, &P6S2::handleol2Pressed);
    connect(ol3, &CircuitComponent::pressed, this, &P6S2::handleol3Pressed);

    resetCircuit();
    QTimer::singleShot(1, this , SLOT(handlePB1Clicked()));
}

void P6S2::resetCircuit() {
    nfb->setActive(true);
    pb1->setActive(false);
    pb2->setActive(false);
    x1->setActive(false);
