...
P6CircuitWindow::P6CircuitWindow(QGraphicsScene *scene, QObject *parent)
    ...
    connect(pb1, &CircuitComponent::pressed, this, &P6CircuitWindow::handlePB1Clicked);
    connect(pb2, &CircuitComponent::pressed, this, &P6CircuitWindow::handlePB2Clicked);
    connect(cos1, &CircuitComponent::pressed, this, &P6CircuitWindow::handlecos1Pressed);

    // Connect OL button signal for motor start
    connect(ol1, &CircuitComponent::pressed, this, &P6CircuitWindow::handleol1Pressed);
    connect(ol2, &CircuitComponent::pressed, this, &P6CircuitWindow::handleol2Pressed);
    connect(ol3, &CircuitComponent::pressed, this, &P6CircuitWindow::handleol3Pressed);
...
void P6CircuitWindow::handlePB1Clicked() {
    qDebug() << "PB1 Pressed";
...
void P6CircuitWindow::handlePB2Clicked() {
    qDebug() << "PB2 Pressed";
...
void P6CircuitWindow::handleol1Pressed() {
...
void P6CircuitWindow::handleol2Pressed() {
    qDebug() << "TH_RY Triggered: Stopping motor and handling COS1 behavior";
    stopMotor();
...
void P6CircuitWindow::handleol3Pressed() {
    qDebug() << "TH_RY Triggered: Stopping motor and handling COS1 behavior";
    stopMotor();
...
void P6CircuitWindow::onBzLightUp() {
...
void P6CircuitWindow::stopBzSound() {
    if (player->playbackState() == QMediaPlayer::PlayingState) {
