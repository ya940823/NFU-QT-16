...
P6S7::P6S7(QGraphicsScene *scene, QObject *parent)
    ...
    connect(pb1, &CircuitComponent::pressed, this, &P6S7::handlePB1Clicked);
    connect(pb2, &CircuitComponent::pressed, this, &P6S7::handlePB2Clicked);
    connect(cos1, &CircuitComponent::pressed, this, &P6S7::handlecos1Pressed);

    // Connect OL button signal for motor start
    connect(ol1, &CircuitComponent::pressed, this, &P6S7::handleol1Pressed);
    connect(ol2, &CircuitComponent::pressed, this, &P6S7::handleol2Pressed);
    connect(ol3, &CircuitComponent::pressed, this, &P6S7::handleol3Pressed);

    resetCircuit();
}

void P6S7::resetCircuit() {
    nfb->setActive(true);
    pb1->setActive(false);
    pb2->setActive(false);
    x1->setActive(false);
